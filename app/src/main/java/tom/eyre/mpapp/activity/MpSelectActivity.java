...
import tom.eyre.mpapp.adapter.MpCompareSelectionAdapter;
...
import tom.eyre.mpapp.fragment.ui.mppartyquiz.mpselect.MpSelectFragment;
import tom.eyre.mpapp.fragment.ui.mppartyquiz.mpselect.MpSelectViewModel;
                ...
                if (adapter != null && list != null) {
                    if (!newText.equalsIgnoreCase("")) {
                        ...
                        if(selectedMpsToCompare == null || selectedMpsToCompare.isEmpty()) {
                            new AnimateUtil().roundOffSearchCorners(searchCv, getApplicationContext());
                        }
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (alreadySelectedOne()) {
                    ...
                    Intent myIntent = new Intent(MpSelectActivity.this, MpExpensesVotesFragmentContainerActivity.class);
